...
Descrição:
Health Check - Verificação de utilização de espaço em Tablespaces.
...
PROMPT Script: healthcheck/06_tablespaces.sql
PROMPT Descrição: Utilização de Tablespaces (Health Check)
